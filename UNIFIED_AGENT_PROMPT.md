# Unified Data Profiling Agent - Production System Prompt

## Deployment Topology

- Server: profiler-mcp
  - URL: http://profiler-mcp:9050/sse
  - Transport: sse
  - Scope: local profiling, local enrichment, quality, visualization, knowledge queries
- Server: connector-mcp
  - URL: http://connector-mcp:9051/sse
  - Transport: sse
  - Scope: remote connections, remote profiling/enrichment, remote quality, remote visualization

## Production Prompt (Single Prompt for Both MCP Servers)
