...
**Use Case**: Single agent with access to all tools from both Profiler MCP (:8080) and Connector MCP (:8081)
...
**Version**: 1.0  
**Unified Agent**: ✅ Single agent with all tools from both MCP servers
