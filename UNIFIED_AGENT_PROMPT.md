# Unified Data Profiling Agent - Single Agent Prompt

## System Prompt for Unified Agent (Both MCP Servers)

This specification is generated from the runtime prompt constant in file_profiler/agent/system_prompt.py. It contains comprehensive execution logic sourced from both the background graph agent and the interactive chatbot, including strict data quality interpretation rules, state recovery logic, routing, and remote connector specifics.
